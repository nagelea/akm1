  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* 按类型统计 */}
        <div className="bg-white rounded-lg shadow p-6">
          <h4 className="text-md font-medium text-gray-900 mb-4">按服务类型</h4>
        ...
        {/* 按严重程度统计 */}
        <div className="bg-white rounded-lg shadow p-6">
          <h4 className="text-md font-medium text-gray-900 mb-4">按严重程度</h4>
        ...
        {/* 按验证状态统计 */}
        <div className="bg-white rounded-lg shadow p-6">
          <h4 className="text-md font-medium text-gray-900 mb-4">按验证状态</h4>
          <div className="space-y-3">
            {Object.entries(stats.byStatus).map(([status, count]) => (
